    ...
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      <div className="absolute inset-0">
        <motion.div
          ...
          style={{
            background: "radial-gradient(circle at top, color-mix(in oklab, var(--primary) 25%, transparent) 0%, transparent 65%)",
          }}
        />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(23,106,157,0.35),transparent_65%)]" />
