  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0B132B] via-[#1C2541] to-[#0B132B] px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 opacity-5">
        <img src="/cybersecurity-expert.png" alt="" className="w-full h-full object-cover mix-blend-screen" />
      </div>
      ...
      <div className="relative z-10 text-center max-w-xs sm:max-w-2xl lg:max-w-4xl mx-auto">
        ...
        >
          About <span className="bg-gradient-to-r from-[#176a9d] to-[#2980b9] bg-clip-text text-transparent">BETATECHHUB</span>
        </motion.h1>
        ...
        >
          Discover our journey, meet our expert team, and learn how we're securing Africa's digital future from our headquarters in Addis Ababa.
        </motion.p>
