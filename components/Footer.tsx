    ...
    <footer className="relative overflow-hidden border-t border-border/40">
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="mb-16 flex flex-col gap-4 rounded-3xl border border-border/40 p-8 shadow-lg sm:flex-row sm:items-center sm:justify-between"
        >
          <div>
            <p className="text-xs uppercase tracking-[0.35em] text-primary">Stay ahead of the threat curve</p>
          ...
          <Link
            href="/contact"
            className="group inline-flex items-center gap-3 rounded-full border border-primary/40 px-5 py-3 text-sm font-semibold text-primary transition duration-300 hover:border-primary/60 hover:bg-primary/10"
          >
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <span className="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-primary/40 text-primary">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-muted-foreground/80 transition-colors hover:text-primary">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services#cybersecurity" className="text-muted-foreground transition-colors hover:text-primary">
